 ...
 * @version 1.9
 */
public class SnmpRequestCustom implements CommandResponder, PDUFactory {
  ...
  public SnmpRequestCustom(String[] args) {
    ...
    if (command != null) {
      ...
      if ((command.getType() != PDU.TRAP) &&
        ...
        try {
          ...
          LogFactory.getLogger(SnmpRequestCustom.class).error(ex);
        }
      }
    }
  }
...
*/
      SnmpRequestCustom snmpRequest = new SnmpRequestCustom(args);
