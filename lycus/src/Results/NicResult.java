...
public class NicResult extends BaseResult {
	...
	public NicResult(String runnableProbeId, long currentTimestamp, long currentInterfaceInOctets,
			long currentInterfaceOutOctets, long previousTimestamp, long previousInterfaceInOctets,
			long previousInterfaceOutOctets) {
